    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-white border border-[#EFE5DC] shadow-warm-sm">
          <BedDouble className="w-4 h-4 text-[#E06D53]" />
          <span className="text-xs font-semibold text-[#2C1810]">
            Overall Facility Occupancy: <strong>{overallBedOccupancyPercent}%</strong>
          </span>
        </div>
      </div>
        ...
        {wards.map((ward) => (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-baseline justify-between pt-2">
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl font-extrabold text-[#2C1810]">{ward.occupied}</span>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs font-mono pt-2">
                <div className="p-2 rounded-xl bg-[#FAF6F2] border border-[#EFE5DC] flex flex-col">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-[#EFE5DC]">
              <span className="text-[11px] text-[#A59288] font-mono">Simulate Admission:</span>
              <div className="flex items-center gap-1.5">
                <button
                  onClick={() => updateWardOccupancy(ward.id, -1)}
                  disabled={ward.occupied <= 0}
                  className="p-1.5 rounded-lg bg-[#FAF6F2] hover:bg-[#F6EFE9] text-[#2C1810] border border-[#EFE5DC] disabled:opacity-30 cursor-pointer"
                  title="Discharge Bed"
                >
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg bg-[#E06D53] hover:bg-[#D25C42] text-white disabled:opacity-30 shadow-warm-sm cursor-pointer"
                  title="Admit to Ward"
                >
